...
public class TraversingHelperTestCase extends WiQueryTestCase
{
	...
	public void testAdd()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.add("span"))
			.render()
			.toString();
	...
	public void testChildren()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.children("span"))
			.render()
			.toString();
	...
	public void testContents()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.contents("span"))
			.render()
			.toString();
	...
	public void testFilter()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.filter("span"))
			.render()
			.toString();
	...
	public void testFind()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.find("span"))
			.render()
			.toString();
	...
	public void testNext()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.next("span"))
			.render()
			.toString();
	...
	public void testNextAll()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.nextAll("span"))
			.render()
			.toString();
	...
	public void testNot()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.not("span"))
			.render()
			.toString();
	...
	public void testParent()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.parent("span"))
			.render()
			.toString();
	...
	public void testParents()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.parents("span"))
			.render()
			.toString();
	...
	public void testPrev()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.prev("span"))
			.render()
			.toString();
	...
	public void testPrevAll()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.prevAll("span"))
			.render()
			.toString();
	...
	public void testSiblings()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.siblings("span"))
			.render()
			.toString();
	...
	public void testSlice()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.slice(1))
			.render()
			.toString();
	...
	public void testSlice2()
	{
		...
		String generatedJavascript = new JsStatement().$(null, "div")
			.chain(TraversingHelper.slice(1, 3))
			.render()
			.toString();
