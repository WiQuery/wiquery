...
public class ComponentMatchers
{
	 ...
	 * @param to
	 *            the final index of the range to be copied, exclusive. (This index may lie outside
	 *            the array.)
	 ...
	 *             if an element copied from <tt>original</tt> is not of a runtime type that can be
	 *             stored in an array of class <tt>newType</tt>. GET FROM THE JDK 1.6
	 */
	@SuppressWarnings("unchecked")
		...
		ComponentMatcher... others)
	{
		...
		ComponentMatcher[] remainderOfOthers = copyOfRange(others, 1, others.length - 1,
