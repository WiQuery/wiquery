...
public abstract class WiQueryWebMarkupContainer extends WebMarkupContainer implements
		IWiQueryPlugin
{
	private static final long serialVersionUID = 1L;

	public WiQueryWebMarkupContainer(String id)
	{
		super(id);
	}

	public WiQueryWebMarkupContainer(String id, IModel< ? > model)
	{
		super(id, model);
	}
