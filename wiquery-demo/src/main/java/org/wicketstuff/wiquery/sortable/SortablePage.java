...
public class SortablePage extends MainTemplate
{
	...
	private List<SimpleSortableElement> elementList = Arrays.asList(
		new SimpleSortableElement(1, "Lorem ipsum"), new SimpleSortableElement(2, "dolor sit"),
		new SimpleSortableElement(3, "consectetur"),
		new SimpleSortableElement(4, "adipiscing elit"), new SimpleSortableElement(5, "Etiam ante"),
		new SimpleSortableElement(6, "erat, lacinia"),
		new SimpleSortableElement(7, "in consectetur et"),
		new SimpleSortableElement(8, "faucibus quis"), new SimpleSortableElement(9, "neque"));
